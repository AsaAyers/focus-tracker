...
import { FocussedWindow, Transform } from '../constants';


export default function runReplacements(record: FocussedWindow) {
  const { transforms } = readSettings()
  // eslint-disable-next-line no-shadow
  return transforms.reduce((record: FocussedWindow, transform: Transform) => {
